        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              We celebrate the milestones, achievements, festivals, and little
              moments that make our journey together memorable.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              From major milestones to spontaneous moments, there is always
              something worth celebrating at AdbuthVerse.
            </p>
          </div>
            ...
            {celebrationImages.map((image, index) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image
                    src={image}
                    alt={`AdbuthVerse celebration ${index + 1}`}
                    fill
                    priority={index < 2}
