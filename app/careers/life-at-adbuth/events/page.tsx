        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              From team gatherings to professional events, we believe the best
              memories are created when we come together, learn together, and
              celebrate together.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              A look at some of the events and experiences that make life at
              AdbuthVerse special.
            </p>
          </div>
      ...
      <section className="border-t border-border bg-surface/50 py-20">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <p className="mt-4 text-muted-foreground">
            Join a team where work, learning, and great experiences come
            together.
          </p>
